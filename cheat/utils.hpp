...
#include <d3d9.h>
#include "Custome.h"
#include "libs/json/include/nlohmann/thirdparty/hedley/hedley.h"
//#include "main.cpp"
...
int GetAowProcId()
{
	...
	Process32FirstL("FortniteClient-Win64-Shipping.exe");
...
FTransform GetBoneIndex(uint64_t mesh, int index)
{
	...
	if (!bonearray) bonearray = read<uint64_t>(mesh + 0x4b0);
